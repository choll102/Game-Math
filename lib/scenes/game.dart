...
import 'package:math_puzzle_1/widgets/tile.dart';
import 'package:math_puzzle_1/widgets/time.dart';
import 'package:math_puzzle_1/widgets/area.dart';
import 'package:math_puzzle_1/widgets/grid.dart';
import 'package:math_puzzle_1/utils/engine.dart';
...
class GameState extends State<GameScene> {
  ...
  DataArea targetArea = new DataArea("Mục Tiêu", Constants.AREA_COLOR);
  DataArea scoreArea = new DataArea("Điểm", Constants.AREA_COLOR);
  DataArea highScoreArea = new DataArea("Điểm Số Tối Đa", Constants.AREA_COLOR);
  Grid gameGrid;
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text("Luật Chơi : " + Engine.operator),
                  ),
                ],
              ),
            ),
