              ...
              ? Container(
                  ...
                  child: Center(
                    ...
                    children: <Widget>[
                      Text(
                        'HẾT THỜI GIAN\n',
                        style: TextStyle(fontSize: 40.0, fontWeight: FontWeight.bold, color: Constants.GAME_OVER_COLOR),
                      ),
                      Text(
                        'ĐIỂM SỐ CỦA BẠN LÀ : ',
                        style: TextStyle(fontSize: 25.0, fontWeight: FontWeight.bold, color: Constants.GAME_OVER_COLOR),
                      ),
                      Text(
                        '$score',
